                            ...
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        echo "<td>" . $row['nama'] . "</td>";
                                        echo "<td>";
                                        echo "edit_unit_kerja.php?id=" . $row['id'] . "'><button class='btn btn-primary'>Edit</button></a>";
                                        echo "<span class='mx-1'></span>";
                                        echo "delete_unit_kerja.php?id=" . $row['id'] . "' onclick='return confirm(\"Yakin Hapus Data?\")'><button class='btn btn-danger'>Delete</button></a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
